...
async function invoiceTemplate({ companyDetails, invoiceNo,buyerDetails, contactDetails, amount, productList, repDetails }) {
    ...
    //company details
    page.drawText(`${companyDetails.companyName}`, {
        ...standardOption,
        x: leftSectionX,
    ...
    Object.values(buyerDetails).forEach((text, index) => {
        page.drawText(`${text}`, {
            ...standardOption,
            x: leftSectionX,
    ...
    Object.values(contactDetails).forEach((text, index) => {
        page.drawText(`${text}`, {
            ...standardOption,
            x: rightSectionX,
            y: height - (190 + 20 * index),
    ...
    const rows = productList.map((obj) => (
        Object.values(obj)
    ));
    ...
    page.drawText(`Make all checks payable to ${companyDetails.companyName}`, {
        ...standardOption,
        x: 30,
        y: 180,
    });
    page.drawText(
        `If you have any questions concerning this invoice, contact ${repDetails.repName}, ${repDetails.repPhone}, ${repDetails.repEmail}`,
        {
            ...standardOption,
            x: 30,
            y: 160,
